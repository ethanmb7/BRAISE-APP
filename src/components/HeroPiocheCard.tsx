      ...
      >
        ...
        <div className="relative mt-1 flex items-end gap-3">
          ...
          <div className="min-w-0 flex-1 pb-0.5">
            ...
            <div className="mt-1.5 flex flex-wrap items-center gap-x-2.5 gap-y-1 text-[#151821]/75">
            ...
            <div className="group relative mt-2.5">
              ...
              <button
                ...
                onClick={handleStart}
                disabled={launching}
                className="relative flex min-h-11 w-full items-center justify-center rounded-xl border-2 border-black bg-[#FFF8EE] px-3 py-2 font-display text-[0.86rem] font-black text-black shadow-[2px_2px_0px_0px_#000] transition-transform duration-100 group-active:translate-y-[2px] group-active:shadow-none disabled:opacity-95"
              >
